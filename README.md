...
in the format
![y = mx + c](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;y%20%3D%20mx%20%2B%20c "y = mx + c")
and using this formula to calculate the unkown values.
...
more complex modelling, we are mostly concerned with the
